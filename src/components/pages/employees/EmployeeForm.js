...
const EmployeeForm = (props) => {
    ...
    const getEmployee = async() => {
        const employeeId = props.match.params.employeeId; // Se identifica el id de la pelicula a editar
        await axios.get(`http://127.0.0.1:8000/api/employees/${employeeId}/`)
        .then(res => {
        ...
        <div>
            ...
            <form method="post">
                <div className="form-group">
                    ...
                    <input type="name" className="form-field" value={name} name="name" id="name" disabled={true} onChange={(e) => handleChange(e)}></input>
                </div>
                <div className="form-group">
                    <label htmlFor="ci">Cédula</label>
                    <input type="ci" className="form-field" value={ci} name="ci" id="ci" disabled={true} onChange={(e) => handleChange(e)}></input>
                </div>
                <div className="form-group">
